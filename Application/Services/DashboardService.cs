...
public sealed class DashboardService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var summary = new DashboardSummaryDto
        {
            ...
            ActiveServices = await _dashboardRepository.CountActiveServicesAsync(filter, cancellationToken),
            ...
            ShuttleRoutesCount = await _dashboardRepository.CountShuttleRoutesAsync(filter, cancellationToken),
