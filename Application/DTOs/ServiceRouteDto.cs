...
public class ServiceRouteDto : OrganizationScopeFieldsDto
{
...
public sealed class CreateServiceRouteDto : OrganizationScopeFieldsDto
{
...
public sealed class UpdateServiceRouteDto : OrganizationScopeFieldsDto
{
    public long ServiceRouteId { get; set; }
